        ...
        >
            <div className="relative flex w-full flex-1 scale-y-75 scale-50 sm:scale-y-100 sm:scale-75 -mt-5 items-center justify-center isolate z-0 ">
                ...
                >
                    ...
                    <div className="bg-transparent absolute w-40 h-[100%] left-0 bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
                </motion.div>
                ...
                >
                    <div className="bg-transparent absolute w-40 h-[100%] right-0 bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
                    <div className="bg-background absolute w-[100%] right-0 h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
                </motion.div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#989898] blur-3xl"
                ></motion.div>
